        ...
        <div className="p-8 space-y-8 animate-in slide-in-from-bottom-4 duration-500">
            <header className="flex justify-between items-end">
                <div>
                    ...
                    <p className="text-slate-400 mt-2 uppercase tracking-widest text-xs">Purification & Distribution Network</p>
                </div>
            </header>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                                        ...
                                        <p className="text-xl font-black text-white">{data?.water ? data.water.temperature_c.toFixed(1) : '--'}°C</p>
                                    </div>
                                    <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                                        <p className="text-[10px] text-slate-500 uppercase font-bold tracking-widest mb-1">Turbidity</p>
                                        <p className="text-xl font-black text-white">{data?.water ? data.water.turbidity_ntu.toFixed(2) : '--'} NTU</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="glass-card p-8">
                            ...
                            <div className="h-[200px] flex items-center justify-center relative">
                                ...
                                <div className="z-10 text-center">
                                    ...
                                    <p className="text-sm font-bold text-white uppercase tracking-widest">Dijkstra Engine Active</p>
                                    <p className="text-xs text-indigo-400 mt-1">Calculating optimal paths...</p>
                                </div>
                            </div>
                            <div className="mt-8 pt-6 border-t border-white/5 grid grid-cols-2 gap-4 h-full">
                                <div>
                                    <p className="text-[10px] text-slate-500 uppercase font-bold mb-1">Active Nodes</p>
                                    <p className="text-lg font-black text-white">12 Locations</p>
                                </div>
                                <div>
                                    <p className="text-[10px] text-slate-500 uppercase font-bold mb-1">Pressure</p>
                                    <p className="text-lg font-black text-white">4.2 bar</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="xl:col-span-4 space-y-6">
                    <div className="glass-card p-6 min-h-[600px] flex flex-col">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="text-lg font-bold text-white">Automation Logs</h3>
                        ...
                        <div className="flex-1 space-y-4 font-mono text-xs">
                            ...
                            <div className="p-3 bg-blue-500/10 border border-blue-500/20 text-blue-400 rounded-lg text-xs leading-relaxed">
                                [0:42:08] INTAKE: Net debris load below threshold. Resetting gears.
                            </div>
                            <div className="p-3 bg-white/5 border border-white/5 text-slate-400 rounded-lg">
                                [0:41:55] FLOW: Current intake stabilized at 45.2 LPM.
                            </div>
                            {[...Array(8)].map((_, i) => (
                                <div key={i} className="p-3 text-slate-600 border-l border-white/5">
                                    [{(10-i)*3}:22:01] TELEMETRY: Sample sequence #{420+i} processed.
                                </div>
                            ))}
                        </div>
                        <button className="mt-6 w-full py-3 bg-white/5 hover:bg-white/10 text-white font-bold rounded-xl transition-colors border border-white/10 flex items-center justify-center gap-2">
                            <Activity size={16} />
                            Full System Audit
                        </button>
                    </div>
